...
# Restart the realestate service
echo "Restarting the realestate service..."
sudo systemctl restart realestate || { echo "Failed to restart realestate. Exiting."; exit 1; }
